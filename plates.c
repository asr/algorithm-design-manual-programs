...
int
dense_layers (double w, double h, double r)
{
...
int
plates_per_row (int row, double w, double r)
{
...
int
dense_plates (double w, double l, double r)
{
...
int
grid_plates (double w, double h, double r)
{
  int layers;                   /* number of layers of balls */
...
int
plates_on_top (int xh, int yh, double w, double l, double r)
{
