...
void
read_flow_graph (flow_graph * g, bool directed)
{                               /* graph to initialize *//* is this graph directed? */
  int i;                        /* counter */
...
/* [[[ netflow_fedge_cut */
edgenode *
find_edge (flow_graph * g, int x, int y)
{
  edgenode *p;                  /* temporary pointer */
...
void
initialize_search (flow_graph * g)
{                               /* graph to traverse */
  int i;                        /* counter */
...
/* [[[ path_volume_cut */
int
path_volume (flow_graph * g, int start, int end, int parents[])
{
  ...
  if (start == parents[end])
    ...
    {
      return (min
              (path_volume (g, start, parents[end], parents), e->residual));
    }
}
